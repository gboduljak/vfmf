...
class Transformer(nn.Module):
  def __init__(self, dim, depth, heads, mlp_dim, dropout=0., use_qk_norm=True, num_registers=0):
  ...
  def forward(self, x, full_shape=None, return_intermediate_layers: bool = False):
